#!/usr/bin/env python
"""
Package metadata for edx_course.
"""
import os
import re
import sys
...
VERSION = get_version('edx_course', '__init__.py')
...
setup(
    name='edx-course',
    version=VERSION,
    description="""API to list/filter edx courses""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/openedx/edx-course',
