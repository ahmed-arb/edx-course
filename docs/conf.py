...
"""
edx-course documentation build configuration file.
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'API to list/filter edx courses',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_course'),
                os.path.join(root_path, 'edx_course/migrations')])
